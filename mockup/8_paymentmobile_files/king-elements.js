$(document).ready(function(){
	...
	if( $('body').hasClass('forms-elements') ) {
		...
		$('.switch-demo2, .switch-radio-demo2').bootstrapSwitch();

		$('.switch-radio-demo2').on('switch-change', function () {
			$('.switch-radio-demo2').bootstrapSwitch('toggleRadioState');
		});
		
		
		$('.switch-demo3, .switch-radio-demo3').bootstrapSwitch();

		$('.switch-radio-demo3').on('switch-change', function () {
			$('.switch-radio-demo3').bootstrapSwitch('toggleRadioState');
		});
